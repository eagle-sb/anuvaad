              ...
              <Grid item xs={12} sm={6} lg={6} xl={6}>
                <MuiThemeProvider theme={theme}>
                  <DropzoneArea className={classes.DropZoneArea}
                    ...
                    dropzoneText={"Please Add/Drop source file here"}
              ...
              <Grid item xs={12} sm={6} lg={6} xl={6}>
                ...
                <MuiThemeProvider theme={theme}>
                  <DropzoneArea className={classes.DropZoneArea}
                    ...
                    filesLimit={1}
                    maxFileSize={200000000000}
                    dropzoneText={"Please Add/Drop target file here"}
                    onDelete={this.handleTargetDelete.bind(this)}
                  />
                </MuiThemeProvider>
